...
tco.order().create(paymentOrderWithSubscriptionSuccessPayload, (err, res) => {
  if (err) {
    console.error(
      'Error getting subscriptions: Error Message: %s',
...
(async () => {
  try {
    ...
    setTimeout(async () => {
      let subscriptions = await subscription.getSubscriptionsByOrderRefNo(
        result.RefNo
      );
...
(async () => {
  try {
    ...
    console.error(
      'Exception retrieving subscription. Error Message: %s',
      JSON.stringify(e, null, 2)
    );
  }
})();
...
(async () => {
  try {
    ...
    console.error(
      'Exception updating subscription. Error Message: %s',
      JSON.stringify(e, null, 2)
    );
  }
})();
...
(async () => {
  try {
    ...
    console.error(
      'Exception disabling subscription. Error Message: %s',
      JSON.stringify(e, null, 2)
    );
  }
})();
...
(async () => {
  try {
    ...
    console.error(
      'Exception enabling subscription. Error Message: %s',
      JSON.stringify(e, null, 2)
    );
  }
})();
