...
import YachtImg from '@/public/assets/common/homepage/YachtImg.svg';
import Button from '@/components/Elements/Button';

const VesselCardComp = () => {
  return (
    <div className="flex lg:justify-between md:w-min md:px-14 w-[300%] px-4">
      <div className="bg-white lg:w-max w-full mx-1 mt-4 rounded-2xl shadow-lg">
        <div className="p-3 lg:flex flex flex-col gap-4 lg:w-[345px]">
          <div className="relative">
            <Image src={YachtImg} alt="" className="w-full" />
          ...
          <div className="flex flex-col justify-between lg:w-full pl-2">
            <p className="text-xl font-bold lg:text-xl lg:mb-5">
              KVARNER - PLASTIC IN THE TROUGH
            </p>
            <div className="flex flex-col justify-between lg:gap-4 gap-4 pt-6 pb-4 lg:pt-0 lg:pb-0 lg:my-0">
              <div className="flex items-center justify-start gap-24 lg:gap-[118px]">
