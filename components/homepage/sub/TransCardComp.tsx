...
import bikeImg from '@/public/assets/common/homepage/homepage-bike-img2.svg';
import Button from '@/components/Elements/Button';
import useMobileDetect from '@/utils/useMobileDetect';

const carDetailsResponse = [1, 2, 3, 4, 5, 6, 7, 8];
  ...
  return (
    <>
      <div className="flex items-center justify-between w-11/12 mx-auto py-3">
        <p className="text-2xl font-bold">Transport vehicles</p>
