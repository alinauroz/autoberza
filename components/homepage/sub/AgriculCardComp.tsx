...
import TractorImg from '@/public/assets/common/homepage/TractorImg.svg';
import Button from '@/components/Elements/Button';

const AgriculCardComp = () => {
  return (
      ...
      <div className="bg-white lg:w-max w-full mx-1 mt-4 rounded-2xl shadow-lg">
        <div className="p-3 lg:flex flex flex-col gap-4 lg:w-[345px]">
          <div className="relative">
            <Image src={TractorImg} alt="" className="w-full" />
...
export default AgriculCardComp;
