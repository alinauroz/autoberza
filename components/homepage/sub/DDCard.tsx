...
const DDCard = () => {
  return (
    <div className="bg-white rounded-md lg:w-[500px] md:w-96 w-56 lg:rounded-xl py-2.5 md:py-6 lg:py-12 lg:-ml-60">
      {/* <div className="bg-white rounded-md lg:w-[500px] w-56 lg:rounded-xl py-3 lg:py-8"> */}
      <p className="text-[10px] md:text-2xl md:pb-3 lg:pb-5 lg:text-3xl font-semibold text-center ">
        Find your right car
      </p>
      <DropDown />
      <div className="flex items-center justify-between w-[82%] md:w-[90%] pt-0.5 md:pt-5 lg:w-full mx-auto ">
        <p className="text-[10px] md:text-lg text-gray-500 font-semibold lg:hidden">
          Advance Search
        </p>
